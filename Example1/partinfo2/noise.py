...
def trainingdata(N_v, N_f):
    ...
    all_X_u_train = np.vstack([leftedge_x, rightedge_x, topedge_x])
    all_u_train = np.vstack([leftedge_u, rightedge_u, topedge_u])
    all_X_un_train = np.vstack([leftedge_x, rightedge_x, topedge_x])
    all_un_train = np.vstack([leftdiff_u, rightdiff_u, topdiff_u])
